...
| :--- | :---- | :----- | :----- |
| 2012&nbsp;to&nbsp;2013 | [CloudMatch]({{< relref "../projects/cloudmatch/index.md" >}} "CloudMatch") | CloudMatch description 📱📲 [(details)]({{< relref "../projects/cloudmatch/index.md" >}} "CloudMatch") | [![Academic Research](cloudmatch-gestures-400.png)]({{< relref "../projects/cloudmatch/index.md" >}} "CloudMatch") |
| 2012&nbsp;to&nbsp;2013 | [Snipper]({{< relref "../projects/snipper/index.md" >}} "Snipper") | Android developer for a startup in the consumer video space -- think Instagram for movies. Occasional work on the Java backend and on a coupled web product. 📽 [(details)]({{< relref "../projects/snipper/index.md" >}} "Snipper") | [![Academic Research](snippernew-400.png)]({{< relref "../projects/snipper/index.md" >}} "Snipper") |
